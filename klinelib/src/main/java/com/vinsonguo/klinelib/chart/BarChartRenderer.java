...
//                                        color);
                                // FIXME: 2021/6/7
                                drawValue(c, dataSet.getValueFormatter().getBarLabel(entry), x, buffer.buffer[bufferIndex + 1] +
                                                (entry.getY() >= 0 ? posOffset : negOffset),
                                        color);
                            }
...
//                                            color);
                                    // FIXME: 2021/6/7
                                    drawValue(c, dataSet.getValueFormatter().getBarStackedLabel(val, entry), x, y, color);
                                }
